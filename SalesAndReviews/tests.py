...
class TestCases(TestCase):
    ...
    def test_Retrieve_Sales_by_Drug_Classification(self):
        response = self.client.post("/SalesAndReviews/Retrieve_Sales_by_Drug_Classification/",
                                    {"year": "2016",
    ...
    def test_Retrieve_Drug_Reviews_for_a_given_Drug(self):
        response = self.client.post("/SalesAndReviews/Retrieve_Drug_Reviews_for_a_given_Drug/",
                                    {"year": "2016",
                                    "drug": "Melatonin"})
        self.assertEqual(response.status_code, 200)
